...
export function mountPanel() {
  element('#app').innerHTML=`
    ...
    <section class="caption"><p>戳一戳 · 拉一拉 · 松开看它晃</p><span>不用赶时间，让快乐多弹一会儿。</span><div class="readings"><div><output id="volume">100.0%</output><small>体积保持</small></div><div><output id="motion">0.00</output><small>晃动能量</small></div><div><output id="eaten">0%</output><small>已尝一口</small></div><div><output id="state">慢慢落下</output><small>此刻状态</small></div></div></section>
    <aside class="controls" aria-label="Pudding controls">
      ...
      <label class="slider-label" for="firmness">弹性 <output id="firmness-value">柔弹</output></label><input id="firmness" type="range" min="0" max="100" value="45" aria-describedby="firmness-value">
      <label class="slider-label" for="damping">回弹收敛 <output id="damping-value">轻轻收住</output></label><input id="damping" type="range" min="0" max="100" value="38" aria-describedby="damping-value">
      <div class="tools" role="group" aria-label="Tool"><button id="tool-grab" data-tool="grab" aria-pressed="true">捏一捏</button><button id="tool-spoon" data-tool="spoon" aria-pressed="false">小勺子</button><button id="bite">尝一口</button></div>
    ...
    <footer>月鹿的布丁 · 本地改作试玩 <span>把日子过得软一点。</span></footer>
