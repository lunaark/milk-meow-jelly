...
export function mountPanel() {
  element('#app').innerHTML=`
    ...
    <nav class="mobile-playbar" aria-label="猫咪快捷玩法"><p id="mobile-tool-hint" role="status">正在捏捏 · 按住猫咪拖动，松手回弹</p><div><button data-tool="grab" aria-pressed="true"><strong>捏一捏</strong><small>切回手指玩</small></button><button data-tool="spoon" aria-pressed="false"><strong>小勺子</strong><small>按住再松手挖</small></button><button id="mobile-reset"><strong>复原猫咪</strong><small>补完整 · 重新捏</small></button></div></nav>
